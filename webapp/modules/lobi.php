...
<div data-role="page" id="lobi">
    ...
    <div data-role="content">
        ...
        <div data-role="navbar" class="nav-glyphish-example">
            ...
            <ul>
                <li><a id="maestros" href="lobiMaster.php" data-role="button" data-transition="slide" data-icon="custom"
                       data-iconpos="right" data-inline="true">Actualizar Maestros</a></li>
            ...
            <ul>
                <li><a id="maestros" href="masterProduct/index.php" data-role="button" data-transition="slide"
                       data-icon="custom" data-iconpos="right" data-inline="true">Productos</a></li>
                <li><a id="inventario" href="stock/index.php" data-role="button" data-ajax="false" data-icon="custom"
                       data-iconpos="right" data-inline="true">Manejar Inventario</a></li>
            </ul>
            ...
            <ul>
                <li><a id="crearp" href="orders/crear.php" data-ajax="false" data-role="button" data-transition="slide"
                       data-icon="custom" data-iconpos="right" data-inline="true">Nuevo Pedido</a></li>
